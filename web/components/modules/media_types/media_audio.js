...
export function renderAudio(area, url, errCall) {
    let filename = clabT("media.unknownAudio");
            ...
            <div class="clab-audio-controls-row" style="display: flex; align-items: center;">
                ...
                <div style="display: flex; align-items: center; gap: 8px; margin-left: auto;">
                    ...
                    <div class="clab-volume-wrap clab-video-controls-interactive" style="background: transparent !important;">
                        <div class="clab-volume-slider-container clab-aud-vol-slider" title="${clabT("media.volumeSlider")}">
                            <div class="clab-volume-slider-track">
                                <div class="clab-volume-slider-fill"></div>
                                <div class="clab-volume-slider-thumb"></div>
                            </div>
                        </div>
                        <button class="clab-media-opt-btn clab-opt-mute" title="${clabT("media.muteToggle")}" style="padding: 4px 6px; background: transparent !important; color: #aaa; transition: color 0.2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#aaa'">
